...
type LoginUserResponse struct {
	...
	Access_TokenExpiresAt  *timestamppb.Timestamp `protobuf:"bytes,5,opt,name=access_Token_expires_at,json=accessTokenExpiresAt,proto3" json:"access_Token_expires_at,omitempty"`
	Refresh_TokenExpiresAt *timestamppb.Timestamp `protobuf:"bytes,6,opt,name=refresh_Token_expires_at,json=refreshTokenExpiresAt,proto3" json:"refresh_Token_expires_at,omitempty"`
}
...
func (x *LoginUserResponse) GetAccess_TokenExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		return x.Access_TokenExpiresAt
	}
	return nil
}

func (x *LoginUserResponse) GetRefresh_TokenExpiresAt() *timestamppb.Timestamp {
	if x != nil {
		return x.Refresh_TokenExpiresAt
	}
	return nil
}
...
var file_rpc_login_user_proto_rawDesc = []byte{
	...
	0x0a, 0x17, 0x61, 0x63, 0x63, 0x65, 0x73, 0x73, 0x5f, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x5f, 0x65,
	...
	0x74, 0x12, 0x53, 0x0a, 0x18, 0x72, 0x65, 0x66, 0x72, 0x65, 0x73, 0x68, 0x5f, 0x54, 0x6f, 0x6b,
	...
	0x70, 0x70, 0x2f, 0x73, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x62, 0x61, 0x6e, 0x6b, 0x62, 0x06, 0x70,
